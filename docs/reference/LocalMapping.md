...
- **[`run`](https://github.com/alejandrofontan/AllFeature-VSLAM/blob/main/src/LocalMapping.cc#L43)** — [`set_accept_keyframes`](https://github.com/alejandrofontan/AllFeature-VSLAM/blob/main/src/LocalMapping_aux.cc#L161), [`has_new_keyframes`](https://github.com/alejandrofontan/AllFeature-VSLAM/blob/main/src/LocalMapping_aux.cc#L101), [`process_keyframe`](https://github.com/alejandrofontan/AllFeature-VSLAM/blob/main/src/LocalMapping.cc#L86), [`stop_if_requested`](https://github.com/alejandrofontan/AllFeature-VSLAM/blob/main/src/LocalMapping_aux.cc#L113), [`is_stopped`](https://github.com/alejandrofontan/AllFeature-VSLAM/blob/main/src/LocalMapping_aux.cc#L125), [`reset_if_requested`](https://github.com/alejandrofontan/AllFeature-VSLAM/blob/main/src/LocalMapping_aux.cc#L194), [`is_finish_requested`](https://github.com/alejandrofontan/AllFeature-VSLAM/blob/main/src/LocalMapping_aux.cc#L222), [`set_finished`](https://github.com/alejandrofontan/AllFeature-VSLAM/blob/main/src/LocalMapping_aux.cc#L228)
- **[`process_keyframe`](https://github.com/alejandrofontan/AllFeature-VSLAM/blob/main/src/LocalMapping.cc#L86)** — [`process_new_keyframe`](https://github.com/alejandrofontan/AllFeature-VSLAM/blob/main/src/LocalMapping.cc#L114), [`cull_map_points`](https://github.com/alejandrofontan/AllFeature-VSLAM/blob/main/src/LocalMapping.cc#L157), [`create_new_map_points`](https://github.com/alejandrofontan/AllFeature-VSLAM/blob/main/src/LocalMapping.cc#L192) → [`cache_neighbor_matches`](https://github.com/alejandrofontan/AllFeature-VSLAM/blob/main/src/LocalMapping.cc#L327), [`create_depth_seeded_points`](https://github.com/alejandrofontan/AllFeature-VSLAM/blob/main/src/LocalMapping.cc#L400); [`search_in_neighbors`](https://github.com/alejandrofontan/AllFeature-VSLAM/blob/main/src/LocalMapping.cc#L431), [`local_bundle_adjustment`](https://github.com/alejandrofontan/AllFeature-VSLAM/blob/main/src/LocalMapping.cc#L500), [`cull_keyframes`](https://github.com/alejandrofontan/AllFeature-VSLAM/blob/main/src/LocalMapping.cc#L511) → [`cull_keyframes_heuristic`](https://github.com/alejandrofontan/AllFeature-VSLAM/blob/main/src/LocalMapping.cc#L533) | [`cull_keyframes_information`](https://github.com/alejandrofontan/AllFeature-VSLAM/blob/main/src/LocalMapping.cc#L587); `LoopClosing::insert_keyframe`; [`log_profile`](https://github.com/alejandrofontan/AllFeature-VSLAM/blob/main/src/LocalMapping_aux.cc#L244)
- **Called from other threads** — queue: [`insert_keyframe`](https://github.com/alejandrofontan/AllFeature-VSLAM/blob/main/src/LocalMapping_aux.cc#L95), [`accepts_keyframes`](https://github.com/alejandrofontan/AllFeature-VSLAM/blob/main/src/LocalMapping_aux.cc#L155), [`set_insertion_lock`](https://github.com/alejandrofontan/AllFeature-VSLAM/blob/main/src/LocalMapping_aux.cc#L167) (Tracking); stop: [`request_stop`](https://github.com/alejandrofontan/AllFeature-VSLAM/blob/main/src/LocalMapping_aux.cc#L107), [`is_stop_requested`](https://github.com/alejandrofontan/AllFeature-VSLAM/blob/main/src/LocalMapping_aux.cc#L131), [`release`](https://github.com/alejandrofontan/AllFeature-VSLAM/blob/main/src/LocalMapping_aux.cc#L137) (LoopClosing); reset: [`request_reset`](https://github.com/alejandrofontan/AllFeature-VSLAM/blob/main/src/LocalMapping_aux.cc#L177), [`is_reset_requested`](https://github.com/alejandrofontan/AllFeature-VSLAM/blob/main/src/LocalMapping_aux.cc#L188) (Tracking); finish: [`request_finish`](https://github.com/alejandrofontan/AllFeature-VSLAM/blob/main/src/LocalMapping_aux.cc#L216), [`is_finished`](https://github.com/alejandrofontan/AllFeature-VSLAM/blob/main/src/LocalMapping_aux.cc#L236) (System)
...
- `objective` = `KeyframeCullingObjective` selects what gram-greedy ranks the feasible candidates (those
  that keep every view within τ) by: `unique` = the candidate's own unique information v_i (the default),
  `minimax` = the worst unexplained view after the cull, `total-loss` = v_i plus the rise of every other
  view's unexplained information. The three names are placecell's
  ([`CullParameters::objective`](https://github.com/alejandrofontan/AllFeature-VSLAM/blob/main/Thirdparty/placecell/include/placecell/placecell.h#L324 "std::string objective")).
...
- settings: `LocalMapping.InformationKernel` (`megaloc`), `LocalMapping.KeyframeCullingMaxUnexplained` (0.3;
  ...
  `LocalMapping.KeyframeCullingMaxPerCall` (5), `LocalMapping.KeyframeCullingObjective` (`unique`),
  `LocalMapping.KeyframeCullingCentred` (1; 0 for `covisibility` when the key is absent).
- called from: [`cull_keyframes`](#cull_keyframes).
...
- fills the static `LocalMapping::params` (`LocalMappingParameters`,
  ...
  option lists (`AF_ERROR` otherwise); `KeyframeCullingObjective` too, but an unknown name only
  `AF_WARN`s and falls back to `unique` (placecell would throw on it inside the mapping thread);
  `KeyframeCullingCentred` is read as an int (`cv::FileStorage` has
...
| `LocalMapping.KeyframeCullingObjective` | `unique` | [`LoadParameters`](#loadparameters) | information: gram-greedy ranking of the feasible candidates — `unique` (own v_i), `minimax` (worst view after the cull) or `total-loss` (v_i plus every other view's rise) |
