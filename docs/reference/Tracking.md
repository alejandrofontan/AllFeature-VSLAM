...
- **[`grab_image`](https://github.com/alejandrofontan/AllFeature-VSLAM/blob/main/src/Tracking.cc#L117)** — builds the `Frame`, then [`track`](https://github.com/alejandrofontan/AllFeature-VSLAM/blob/main/src/Tracking.cc#L152), [`log_profile`](https://github.com/alejandrofontan/AllFeature-VSLAM/blob/main/src/Tracking_aux.cc#L136)
- **[`track`](https://github.com/alejandrofontan/AllFeature-VSLAM/blob/main/src/Tracking.cc#L152)** — [`monocular_initialization`](https://github.com/alejandrofontan/AllFeature-VSLAM/blob/main/src/Tracking.cc#L260) *or* [`check_replaced_in_last_frame`](https://github.com/alejandrofontan/AllFeature-VSLAM/blob/main/src/Tracking.cc#L576) + [`track_reference_keyframe`](https://github.com/alejandrofontan/AllFeature-VSLAM/blob/main/src/Tracking.cc#L586) *or* [`relocalize`](https://github.com/alejandrofontan/AllFeature-VSLAM/blob/main/src/Tracking.cc#L1091); then [`track_local_map`](https://github.com/alejandrofontan/AllFeature-VSLAM/blob/main/src/Tracking.cc#L676), [`log_heartbeat`](https://github.com/alejandrofontan/AllFeature-VSLAM/blob/main/src/Tracking_aux.cc#L119), [`need_new_keyframe`](https://github.com/alejandrofontan/AllFeature-VSLAM/blob/main/src/Tracking.cc#L869) → [`create_new_keyframe`](https://github.com/alejandrofontan/AllFeature-VSLAM/blob/main/src/Tracking.cc#L1033), [`store_relative_pose`](https://github.com/alejandrofontan/AllFeature-VSLAM/blob/main/src/Tracking.cc#L254), [`wait_for_idle_local_mapper`](https://github.com/alejandrofontan/AllFeature-VSLAM/blob/main/src/Tracking.cc#L1052) (sequential mode). Each tracking stage runs inside [`run_tracking_stage`](https://github.com/alejandrofontan/AllFeature-VSLAM/blob/main/src/Tracking_aux.cc#L106).
- **[`monocular_initialization`](https://github.com/alejandrofontan/AllFeature-VSLAM/blob/main/src/Tracking.cc#L260)** — [`attempt_monocular_initialization`](https://github.com/alejandrofontan/AllFeature-VSLAM/blob/main/src/Tracking.cc#L268) → [`create_initial_map`](https://github.com/alejandrofontan/AllFeature-VSLAM/blob/main/src/Tracking.cc#L366) (→ `reset` on a degenerate map)
- **[`track_local_map`](https://github.com/alejandrofontan/AllFeature-VSLAM/blob/main/src/Tracking.cc#L676)** — [`update_local_map`](https://github.com/alejandrofontan/AllFeature-VSLAM/blob/main/src/Tracking.cc#L719) → [`update_local_keyframes`](https://github.com/alejandrofontan/AllFeature-VSLAM/blob/main/src/Tracking.cc#L728), [`update_local_points`](https://github.com/alejandrofontan/AllFeature-VSLAM/blob/main/src/Tracking.cc#L811); [`search_local_points`](https://github.com/alejandrofontan/AllFeature-VSLAM/blob/main/src/Tracking.cc#L834)
- **[`need_new_keyframe`](https://github.com/alejandrofontan/AllFeature-VSLAM/blob/main/src/Tracking.cc#L869)** — [`median_flow_from_last_frame`](https://github.com/alejandrofontan/AllFeature-VSLAM/blob/main/src/Tracking.cc#L1058) (diagnostic line only)
- **[`relocalize`](https://github.com/alejandrofontan/AllFeature-VSLAM/blob/main/src/Tracking.cc#L1091)** — [`accept_relocalization_hypothesis`](https://github.com/alejandrofontan/AllFeature-VSLAM/blob/main/src/Tracking.cc#L1168)
- Not in the graph (setup / recovery): [`LoadParameters`](https://github.com/alejandrofontan/AllFeature-VSLAM/blob/main/src/Tracking.cc#L37), [`Tracking`](https://github.com/alejandrofontan/AllFeature-VSLAM/blob/main/src/Tracking.cc#L93) → [`load_camera_parameters`](https://github.com/alejandrofontan/AllFeature-VSLAM/blob/main/src/Tracking_aux.cc#L20), [`get_feature_extractor`](https://github.com/alejandrofontan/AllFeature-VSLAM/blob/main/src/Tracking_aux.cc#L97); [`reset`](https://github.com/alejandrofontan/AllFeature-VSLAM/blob/main/src/Tracking.cc#L1234)
...
- called from: [`System::Track`](https://github.com/alejandrofontan/AllFeature-VSLAM/blob/main/src/System.cc#L360 "tracker->grab_image"), once per image.
...
- information bands: `PlaceRecognition::keyframe_information` returns the view's unexplained information `v ∈ [0,1]` given `local_keyframes_` (placecell, same kernel and centring as keyframe culling). `v` below `Tracking.KeyframeMinInformation` → `redundant`, no keyframe unless forced; `v` above tau (`LocalMapping.KeyframeCullingMaxUnexplained`) → `novel`, a trigger on its own. With `vpr: none` there is no `v` and only the health triggers decide.
...
- every decision (skips included) is recorded through `PlaceRecognition::record_keyframe_decision` with its reason string; insertions always log one `AF_INFO` line with the information value, and `Tracking.LogKeyframeInformation` adds one line per tracked frame with flow, inliers, overlap and every trigger flag.
...
### `median_flow_from_last_frame`

```cpp
std::optional<float> Tracking::median_flow_from_last_frame() const
```
- median pixel displacement of the map points shared between `last_frame_` and `current_frame_`; empty with fewer than `Tracking.MinSharedPointsForFlow` shared points. Diagnostic only (the `LogKeyframeInformation` line); `Tracking.MinMedianFlow` is kept as the static-camera reference value but gates nothing.
- settings: `Tracking.MinSharedPointsForFlow` (20), `Tracking.MinMedianFlow` (1.0).
...
- called from: [`System::System`](https://github.com/alejandrofontan/AllFeature-VSLAM/blob/main/src/System.cc#L53 "Tracking::LoadParameters"), before any thread starts.
...
- called from: [`System::System`](https://github.com/alejandrofontan/AllFeature-VSLAM/blob/main/src/System.cc#L193 "make_shared<Tracking>").
...
- called from: [`create_initial_map`](#create_initial_map) on a degenerate map and [`System::reset`](https://github.com/alejandrofontan/AllFeature-VSLAM/blob/main/src/System.cc#L355 "tracker->reset").
...
| `Tracking.MinMedianFlow` | 1.0 | [`LoadParameters`](#loadparameters) | px; static-camera reference for the diagnostic line, gates nothing |
| `Tracking.MinSharedPointsForFlow` | 20 | [`LoadParameters`](#loadparameters) | shared points the flow estimate needs ([`median_flow_from_last_frame`](#median_flow_from_last_frame)) |
