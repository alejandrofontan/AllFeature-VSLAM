...
- called from: [`Tracking::reset`](https://github.com/alejandrofontan/AllFeature-VSLAM/blob/main/src/Tracking.cc#L1242 "viewer_->request_stop()"), which then polls [`is_stopped`](#is_stopped) every 3 ms before touching the map.
...
- called from: [`Tracking::reset`](https://github.com/alejandrofontan/AllFeature-VSLAM/blob/main/src/Tracking.cc#L1283 "viewer_->release()"), after the map, the VPR database and the ids have been reset.
